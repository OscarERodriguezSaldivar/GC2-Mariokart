...
public:	
	...
	//	model = new ModeloRR(d3dDevice, d3dContext, "Assets/Cofre/Cofre.obj", L"Assets/Cofre/Cofre-color.png", L"Assets/Cofre/Cofre-spec.png", 0, 0);
		...
		GoKart = new ModeloRR(d3dDevice, d3dContext, "Assets/GoKart/GoKart.obj", L"Assets/GoKart/GoKartcolor.png", L"Assets/GoKart/GoKartspec.png", 18, 6);
		...
		Mario = new ModeloRR(d3dDevice, d3dContext, "Assets/Mario/Mario2.obj", L"Assets/Mario/mario_main.png", L"Assets/noSpecMap.jpg", 18, 6);
	...
	void Render(void)
	{
		...
		GoKart->setPosX(camara->hdveo.x);
		GoKart->setPosZ(camara->hdveo.z);
		Mario->setPosX(camara->hdveo.x);
		Mario->setPosZ(camara->hdveo.z);
		GoKart->Draw(camara->vista, camara->proyeccion, terreno->Superficie(GoKart->getPosX(), GoKart->getPosZ()), camara->posCam, GoKart->colorChange,10.0f, 270 * (XM_PI / 180) + rotCam, 'Y', 2, true, true, tipoVista);
